...
export default function Product() {
    return (
        <section className="bg-white min-h-screen my-0 relative w-full relative">
            ...
            <div className="sticky top-0 z-[2] w-full flex flex-col mb-[-10px]">
            ...
            <div className="bg-white flex flex-col gap-2 shadowAlter z-[5] sticky rounded-xl">
                ...
                <div>
                    <h2 className="pl-4 my-5 font-semibold text-base">Opcionais</h2>
